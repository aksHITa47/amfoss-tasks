...
public class MathQuiz extends JFrame {
    ...
    public MathQuiz() {
        ...
        //defining objects 
	  //Change radioButton1 to Multiply and radioButton3 to Add
        radioButton1 = new JRadioButton("Multiply");
        radioButton2 = new JRadioButton("Subtract");
        radioButton3 = new JRadioButton("Add");
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                if (doubleOfInput == result) {
                    correctCount++; // increasing counter //-- to ++ error
